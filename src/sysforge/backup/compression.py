...
class CompressorBase:
    ...
    def create_compressor(self, output_file: BinaryIO) -> Any:
...
class Lz4Compressor(CompressorBase):
    ...
    def create_compressor(self, output_file: BinaryIO) -> Any:
        ...
        return lz4.frame.LZ4FrameFile(
            output_file, mode="wb", compression_level=self.level
        )
...
class NoCompressor(CompressorBase):
    ...
    def create_compressor(self, output_file: BinaryIO) -> BinaryIO:
...
class CompressedTarFile:
    ...
    def __init__(
        self, output_path: Path, format_type: CompressionFormat, compression_level: int
    ):
    ...
    def add(self, file_path: Path, arcname: Optional[str] = None) -> None:
    ...
    def add_string(self, content: str, arcname: str) -> None:
