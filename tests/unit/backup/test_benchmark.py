...
class TestBenchmarkCommand:
    ...
    def test_benchmark_command_with_valid_workers(self):
        ...
        with patch('sysforge.backup.cli._load_config') as mock_load_config:
            ...
            with patch('sysforge.backup.cli.create_backup', side_effect=mock_results * 6):  # 2 workers * 2 iterations * 3 calls
    ...
    def test_benchmark_command_with_invalid_workers(self):
    ...
    def test_benchmark_command_saves_results_to_file(self):
        ...
        try:
            with patch('sysforge.backup.cli._load_config') as mock_load_config:
                ...
                with patch('sysforge.backup.cli.create_backup', side_effect=mock_results * 3):  # 1 worker * 3 iterations
    ...
    def test_benchmark_command_handles_exceptions(self):
        ...
        with patch('sysforge.backup.cli._load_config') as mock_load_config:
            ...
            with patch('sysforge.backup.cli.create_backup', side_effect=Exception("Test error")):
                with patch('rich.console.Console') as mock_console_class:
                    mock_console = Mock()
                    mock_console_class.return_value = mock_console
    ...
    def test_benchmark_command_path_expansion(self):
    ...
    def test_benchmark_empty_results_handling(self):
        ...
        with patch('sysforge.backup.cli._load_config') as mock_load_config:
            ...
            with patch('sysforge.backup.cli.create_backup', side_effect=Exception("Always fails")):
                with patch('rich.console.Console') as mock_console_class:
                    mock_console = Mock()
                    mock_console_class.return_value = mock_console
