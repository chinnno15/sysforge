...
class TestConflictInfo:
    ...
    def test_conflict_info_nonexistent_file(self) -> None:
...
class TestRestoreOperation:
    ...
    def test_restore_operation_initialization(self) -> None:
    ...
    def test_restore_archive_nonexistent(self) -> None:
    ...
    def test_detect_conflicts(self, mock_list_archive) -> None:
    ...
    def test_get_target_path_with_target_dir(self) -> None:
    ...
    def test_get_target_path_without_target_dir(self) -> None:
    ...
    def test_handle_conflicts_overwrite(self) -> None:
    ...
    def test_handle_conflicts_skip(self) -> None:
    ...
    @patch("shutil.copy2")
    def test_handle_conflicts_backup(self, mock_copy) -> None:
    ...
    def test_handle_conflicts_interactive_overwrite(self, mock_ask) -> None:
    ...
    @patch("sysforge.backup.restore.Prompt.ask")
    def test_handle_conflicts_interactive_skip(self, mock_ask) -> None:
    ...
    @patch("shutil.copy2")
    @patch("sysforge.backup.restore.Prompt.ask")
    def test_handle_conflicts_interactive_backup(self, mock_ask, mock_copy) -> None:
    ...
    @patch("sysforge.backup.restore.Prompt.ask")
    def test_handle_conflicts_interactive_quit(self, mock_ask) -> None:
    ...
    def test_backup_existing_file_error(self) -> None:
    ...
    @patch("os.chmod")
    @patch("os.utime")
    def test_restore_permissions(self, mock_utime, mock_chmod) -> None:
    ...
    @patch("sysforge.backup.restore.Decompressor.list_archive")
    def test_restore_archive_dry_run(self, mock_list_archive) -> None:
...
class TestRestoreUtilityFunction:
    ...
    def test_restore_backup(self, mock_restore_op_class) -> None:
